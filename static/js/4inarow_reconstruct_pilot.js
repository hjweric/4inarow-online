...
function initialize_task(_num_games,_num_practice_games,callback){
    ...
    instructions_text = ["Please do not refresh the website at any point during the game, as it will cause the data to be lost. ",
        ...
        "Then, you will see several circles (the number of circles range from 4-8) appear on the screen, one at a time. Click next to see the first circle. ",
